...
train_x = training_data_folder + '/sagittal-traindata-dwi.npy'
train_y = training_data_folder + '/sagittal-traindata-mask.npy'
...
csv_logger = CSVLogger(training_data_folder + '/sagittal.csv', append=True, separator=';')

# checkpoint
filepath = training_data_folder + "/weights-sagittal-improvement-{epoch:02d}.h5"
...
model.save_weights(training_data_folder + "/CompNetBasicModel_weights_DWI_sagittal_final.h5")
