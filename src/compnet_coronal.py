...
train_x = training_data_folder + '/coronal-traindata-dwi.npy'
train_y = training_data_folder + '/coronal-traindata-mask.npy'
...
# checkpoint
filepath = training_data_folder + "/weights-coronal-improvement-{epoch:02d}.h5"
...
model.save_weights(training_data_folder + "/CompNetBasicModel_weights_DWI_coronal_final.h5")
