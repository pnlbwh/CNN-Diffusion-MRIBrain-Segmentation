...
train_x = '../data/output/train_allview_1022_sagittal.npy'
train_y = '../data/output/trainMask_allview_1022_sagittal.npy'
...
csv_logger = CSVLogger('sagittal.csv', append=True, separator=';')

# checkpoint
filepath="weights-sagittal-improvement-{epoch:02d}.h5"
...
history_callback = model.fit([x_train], [y_train,y_train,y_train,y_train,y_train,y_train,y_train,y_train,
                      ...
                      batch_size=4, epochs=10,shuffle=True, callbacks=[csv_logger, checkpoint])

import h5py
# serialize model to JSON
model_json = model.to_json()
with open("../model/CompNetmodel_arch_DWI_sagittal.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("../model/CompNetmodel_weights_DWI_sagittal.h5")
